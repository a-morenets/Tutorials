...
public class PrintRepeats {
    ...
    public static void findRepeatsSecond( int[] arrayFirst,
        ...
        Objects.requireNonNull(arrayFirst , "arrayFirst cann't be null");
        Objects.requireNonNull(secondArray , "secondArray cann't be null");
        Objects.requireNonNull(result , "result cann't be null");
        checkEmpty(result);
