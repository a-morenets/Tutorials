package specialSamples.association;


import specialSamples.association.entities.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Driver johnDriver = new Driver(john, new DriverLicense(new Date(), DriverLicense.Category.C, new Date()));
